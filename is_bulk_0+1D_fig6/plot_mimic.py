...
for key, vals in bulk_dict.items():
    ...
    T_array=[ hbarc*esol.integrate(tau) for tau in tau_range ]
...
plt.axhline(y=0.002, color=color, linestyle=style, linewidth=6) 
...
#plt.legend()
plt.tight_layout()
plt.savefig("T_profile_equiv_zeta_over_s_Pi0_mimic.pdf")
plt.show()
